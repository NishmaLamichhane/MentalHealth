@extends('layouts.app')
@section('content')
<h1 class="text-4xl font-bold text-black dark:text-white">Add Category</h1>
...
<div class="mt-5">
    <form action="{{route('category.store')}}" method="POST" enctype="multipart/form-data">
        ...
        <input type="text" name="name" class="w-full rounded-lg p-3 m-3" placeholder="Enter Category" id="name" value="{{old('name')}}">
        @error('name')
        <p class="text-red-500 mt-2">{{$message}}</p>
        @enderror
