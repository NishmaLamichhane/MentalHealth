...
<div class="container mx-auto px-4 py-8 max-w-3xl">
    ...
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900 dark:text-white flex items-center">
            <i class="ri-edit-2-line mr-3 text-blue-600"></i>
            Edit Specialist
        </h1>
        ...
        <p class="mt-3 text-gray-600 dark:text-gray-400">
            Update specialist information below.
        </p>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden">
        ...
        <div class="p-6">
            ...
            <form action="{{ route('specialist.update', $specialist->id) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <i class="ri-sort-number-desc text-gray-400"></i>
                        </div>

                        <input type="number"
                               name="priority"
                               value="{{ old('priority', $specialist->priority) }}"
        ...
        <div class="flex gap-3">
            ...
            <div>
                ...
                <p class="text-sm text-blue-700 dark:text-blue-400 mt-1">
                    Changes will be reflected immediately in therapist assignments and listings.
                </p>
            </div>
        </div>
    </div>
